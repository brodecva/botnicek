 ...
 */
package cz.cuni.mff.ms.brodecva.botnicek.ide.designer.models.aiml.elements.template.lists;
...
public final class NameAndValueListItem extends AbstractListItem {
    ...
    public Set<Attribute> getAttributes() {
        return ImmutableSet.of(Attribute.create(ATT_NAME, this.name), Attribute.create(ATT_VALUE, this.value));
    }
}
