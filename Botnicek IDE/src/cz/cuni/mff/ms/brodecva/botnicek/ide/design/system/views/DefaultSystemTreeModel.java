...
final class DefaultSystemTreeModel implements SystemTreeModel {
     ...
     * @return model
     */
    public static SystemTreeModel create(final SystemController systemController) {
     ...
     * 
     * @param systemController řadič systému
     * @param comparator komparátor sítí
     * @return model
     */
    static SystemTreeModel create(final SystemController systemController, final Comparator<? super Network> comparator) {
        Preconditions.checkNotNull(systemController);
        
        final SystemTreeModel newInstance = new DefaultSystemTreeModel(systemController, comparator);
        
        return newInstance;
    }
    
    private DefaultSystemTreeModel(final SystemController systemController, final Comparator<? super Network> comparator) {
        Preconditions.checkNotNull(systemController);
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.views.SystemTreeModel#systemNameChanged(cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.model.System)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.views.SystemTreeModel#networkRemoved(cz.cuni.mff.ms.brodecva.botnicek.ide.design.networks.model.Network)
     */
    @Override
    public void networkRemoved(final Network network) {
        ...
        final TreeModelEvent event = new TreeModelEvent(this, new Object[] { this.root }, new int[] { removedIndex }, new Object[] { removed });
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.views.SystemTreeModel#networkRenamed(cz.cuni.mff.ms.brodecva.botnicek.ide.design.networks.model.Network)
     */
    @Override
    public void networkRenamed(final Network network) {
        ...
        final TreeModelEvent removeEvent = new TreeModelEvent(this, new Object[] { this.root }, new int[] { removedIndex }, new Object[] { removed });
        final TreeModelEvent insertEvent = new TreeModelEvent(this, new Object[] { this.root }, new int[] { addIndex }, new Object[] { added });
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.views.SystemTreeModel#systemSet(cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.model.System)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.system.views.SystemTreeModel#networkAdded(cz.cuni.mff.ms.brodecva.botnicek.ide.design.networks.model.Network)
     */
    @Override
    public void networkAdded(final Network added) {
        ...
        final TreeModelEvent event = new TreeModelEvent(this, new Object[] { this.root }, new int[] { this.children.indexOf(added) }, new Object[] { added });
