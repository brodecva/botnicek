...
public final class ExitProcessingNode extends AbstractNode implements ProcessingNode, ExitNode {
    ...
    public static ExitProcessingNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected ExitProcessingNode(final String name, final Network parent, final int x, final int y) {
