 ...
 * @version 1.0
 */
public final class EnterOrderedProcessingNode extends AbstractNode implements
        OrderedNode, ProcessingNode, EnterNode {
     ...
     * @return uzel
     */
    public static EnterOrderedProcessingNode create(final NormalWord name,
    ...
    private EnterOrderedProcessingNode(final NormalWord name,
            final Network parent, final int x, final int y) {
