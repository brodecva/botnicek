...
public class PatternArcPanel extends AbstractTypePanel {
    ...
    private static final Dimension TEXT_FIELD_REQUIRED_DIMENSION =
    ...
    public static
        ...
        final MixedPatternTextField patternTextField =
                MixedPatternTextField.create(parent,
                        mixedPatternValidationController);
        final MixedPatternTextField thatTextField =
                MixedPatternTextField.create(parent,
                        mixedPatternValidationController);

        final PatternArcPanel newInstance =
                new PatternArcPanel(arcController, patternTextField,
                        thatTextField);
    ...
    private final JLabel patternLabel =
            new JLabel(UiLocalizer.print("Pattern"));
    private final MixedPatternTextField patternTextField;

    private final JPanel thatPane = new JPanel();

    private final JLabel thatLabel = new JLabel(
            UiLocalizer.print("ThatPattern"));

    private final MixedPatternTextField thatTextField;

    private PatternArcPanel(final ArcController arcController,
            final MixedPatternTextField patternTextField,
            final MixedPatternTextField thatTextField) {
        Preconditions.checkNotNull(arcController);
        ...
        this.patternPane.setLayout(new BoxLayout(this.patternPane,
                BoxLayout.X_AXIS));
        this.patternPane.add(this.patternLabel);
        this.patternPane.add(Box
     ...
     * #save(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.types.NormalWord,
    ...
    public void
        ...
        this.arcController.updatePattern(newName, priority,
                this.patternTextField.getText(), this.thatTextField.getText(),
                code);
    }
