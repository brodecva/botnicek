...
public final class DragOrderableList<E> extends JList<E> {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    final DragOrderableList<String> list = DragOrderableList.<String>create(model);
     ...
     * 
     * @param model inicializační model
     * @return seznam inicializovaný daným modelem
     */
    public static <E> DragOrderableList<E> create(final DefaultListModel<E> model) {
        Preconditions.checkNotNull(model);
        
        final DragOrderableList<E> newInstance = new DragOrderableList<E>(model);
     ...
     * 
     * @param fromIndex původní index prvku
     * @param toIndex nový index prvku
     * @throws IllegalStateException pokud byl změněn model seznamu na jiný než výchozí
     */
     ...
     * 
     * @param element přidá prvek do seznamu
     */
     ...
     * 
     * @param index index smazaného prvku
     * @throws IllegalStateException pokud byl změněn model na jiný než výchozí
     */
