...
public final class InnerOrderedProcessingNode extends AbstractNode implements OrderedNode, ProcessingNode, InnerNode {
    ...
    public static InnerOrderedProcessingNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected InnerOrderedProcessingNode(final String name, final Network parent, final int x, final int y) {
