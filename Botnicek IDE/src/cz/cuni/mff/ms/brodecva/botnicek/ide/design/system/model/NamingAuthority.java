...
/**
 * <p>
 * Autorita, která přiděluje nekonfliktní názvy.
 * </p>
 * <p>
 * Z implementačních důvodů je nutné rezervovat některé názvy, autorita umožňuje
 * uživateli užívat vlastní názvy tak, aby bylo zajištěno, že se nebudou
 * shodovat s již použitými.
 * </p>
 * 
...
public interface NamingAuthority {
    ...
    /**
     * Pokusí se nahradit sérii názvů již přítomných, v případě selhání nedojde
     * k aktualizaci autority.
     * 
     * @param oldToNew
     *            nahrazující názvy
     ...
     *            názvy
     * @throws IllegalArgumentException
     *             pokud je některý z názvu nepoužitelný v původní podobě
     */
    void tryUse(String... names);

    /**
     * Zkusí užít název. V případě, že je konfliktní či nevhodný, autorita se
     * pro něj bude snažit vygenerovat podobný, ten užije a vrátí uživateli
     * zpět.
     * 
     * @param name
     *            název
