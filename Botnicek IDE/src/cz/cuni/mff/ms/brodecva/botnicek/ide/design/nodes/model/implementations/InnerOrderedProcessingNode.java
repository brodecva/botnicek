 ...
 * @version 1.0
 */
public final class InnerOrderedProcessingNode extends AbstractNode implements
        OrderedNode, ProcessingNode, InnerNode {
     ...
     * @return uzel
     */
    public static InnerOrderedProcessingNode create(final NormalWord name,
    ...
    private InnerOrderedProcessingNode(final NormalWord name,
            final Network parent, final int x, final int y) {
