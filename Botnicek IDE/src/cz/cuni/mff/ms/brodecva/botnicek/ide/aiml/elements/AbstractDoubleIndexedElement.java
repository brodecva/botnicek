...
/**
 * <p>
 * Abstraktní třída prvku který má dvourozměrný kladný celočíselný index zapsaný
 * v atributu index s oddělovačem čárka.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Volitelně lze vynechat (i jen pouze druhou část), pak značí index s čísly 1 a
 * 1 (resp. zadaná část a 1).
 * </p>
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public abstract class AbstractDoubleIndexedElement extends
        AbstractProperElement {
    ...
    private AbstractDoubleIndexedElement(final Optional<Index> index,
            final Optional<TwoDimensionalIndex> index2d) {
     ...
     * {@inheritDoc}
     * 
     * Poskytne jediný atribut s indexem v případě explicitního zadání. V
     * případě implicitně zadané druhé části bude index jednorozměrný.
     */
    @Override
    public Set<Attribute> getAttributes() {
        ...
        if (this.index.isPresent()) {
            ...
            return ImmutableSet.<Attribute> of(AttributeImplementation.create(
                    ATT_INDEX, String.format("%s" + AIML.INDICES_DELIMITER
                            + "%s", raw2dIndex.getFirstValue(),
                            raw2dIndex.getSecondValue())));
        } else {
    ...
    public String toString() {
        return "AbstractDoubleIndexedElement [index=" + this.index
                + ", index2d=" + this.index2d + ", getClass()=" + getClass()
                + "]";
    }
}
