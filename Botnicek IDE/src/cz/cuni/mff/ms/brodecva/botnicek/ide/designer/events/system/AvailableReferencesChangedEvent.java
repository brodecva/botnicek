 ...
 * @version 1.0
 */
public class AvailableReferencesChangedEvent implements Event<AvailableReferencesChangedListener> {
    
    private final Set<EnterNode> references;
    
    public static AvailableReferencesChangedEvent create(final Set<EnterNode> references) {
        return new AvailableReferencesChangedEvent(references);
    }
    
    private AvailableReferencesChangedEvent(final Set<EnterNode> references) {
