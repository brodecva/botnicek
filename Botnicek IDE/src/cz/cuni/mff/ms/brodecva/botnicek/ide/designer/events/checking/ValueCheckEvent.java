...
import cz.cuni.mff.ms.brodecva.botnicek.ide.designer.models.design.arcs.TestArc;
 ...
 * @version 1.0
 */
public class ValueCheckEvent implements Event<ValueCheckListener> {
    
    private final TestArc arc;
    private final SimplePatternCheckResult result;
    
    public static ValueCheckEvent create(final TestArc arc, final SimplePatternCheckResult result) {
        return new ValueCheckEvent(arc, result);
    }
    
    private ValueCheckEvent(final TestArc arc, final SimplePatternCheckResult result) {
     ...
     */
    @Override
    public void dispatchTo(final ValueCheckListener listener) {
