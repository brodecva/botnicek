...
/**
 * Validátor řetězce s předpokládaným kódem šablony jazyka AIML, který vysílá po
 * kontrole událost s výsledkem.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public interface CodeValidator extends Validator<Code> {
    /**
