...
/**
 * <p>
 * Nastaví predikát daného názvu hodnotu určenou výstupem z vyhodnocení potomků.
 * Samotný výstup toho predikátu je právě nastavená hodnota, za předpokladu, že
 * není pro daný predikát specifikováno v konfiguraci jinak.
 * </p>
 * <p>
 * Interpretu by totiž mělo být možné zadat, u kterých predikátů se po nastavení
 * bude vracet nastavená hodnota, a u kterých místo ní název predikátu.
 * </p>
 * 
 * @author Václav Brodec
 * @version 1.0
 * @see <a
 *      href="http://www.alicebot.org/TR/2011/#section-set">http://www.alicebot.org/TR/2011/#section-set</a>
 */
public final class Set extends AbstractCompoundElement implements
        CaptureElement {
     ...
     * 
     * @param name
     *            název nastavovaného predikátu
     * @param content
     *            potomci (jejichž výstup bude uložen do predikátu)
     * @return prvek
     */
