...
public final class IsolatedInputNode extends AbstractNode implements IsolatedNode, InputNode {
    ...
    public static IsolatedInputNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected IsolatedInputNode(final String name, final Network parent, final int x, final int y) {
