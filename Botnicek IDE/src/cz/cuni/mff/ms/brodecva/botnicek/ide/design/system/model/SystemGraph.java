...
/**
 * <p>
 * Graf hran a uzlů systému. Kromě vztahů uzlů a hran ukládá i jejich názvy.
 * </p>
 * <p>
 * Dále podporuje opravy typů uzlů po strukturálních změnách.
 * </p>
 * 
...
public interface SystemGraph {
    ...
    /**
     * Přidá hranu a opraví její koncové uzly (změny se dále nepropagují, neboť
     * jsou určené změnou stupňů postižených vrcholů) tak, aby byl vzniklý graf
     * opět konzistentní částí modelu ATN.
     * 
     * @param added
     *            přidaná hrana
     * @param from
     ...
     *            cílový uzel hrany
     * @param processor
     *            procesor vypočítávající provedené nahrazení uzlů v okolí
     * @param initials
     *            vstupní uzly
    ...
    /**
     * <p>
     * Odstraní uzly a přilehlé hrany.
     * </p>
     * <p>
     * Pro zachování konzistence grafu je nutné, aby byly odstraněny všechny
     * související uzly!
     * </p>
     * 
     * @param purged
    ...
    /**
     * Odstraní hranu a opraví koncové uzly (změny se dále nepropagují, neboť
     * jsou určené změnou stupňů postižených vrcholů) tak, aby byl vzniklý graf
     * opět konzistentní částí modelu ATN.
     * 
     * @param removed
     ...
     *            procesor vypočítávající provedené nahrazení uzlů v okolí
     * @param references
     *            aktuální odkaz mezi uzly
     * @param initials
     *            vstupní uzly
     * @return pokyny k aktualizaci systému na základě změny
     * @throws IllegalArgumentException
     *             pokud je změnou postižený uzel cílem odkazu, pak nemůže být
     *             změněn
     */
            Update
            removeAndRealign(
    ...
    /**
     * Odstraní uzel a opraví jeho nejbližší okolí (změny se dále nepropagují,
     * neboť jsou určené změnou stupňů postižených vrcholů) tak, aby byl vzniklý
     * graf opět konzistentní částí modelu ATN.
     * 
     * @param removed
     *            odstraněný uzel
     * @param processor
     ...
     * @return pokyny k aktualizaci systému na základě změny
     * @throws IllegalArgumentException
     *             pokud jsou odstraněný nebo změnou postižený uzel cílem
     *             odkazu, pak změnu nelze provést
     */
            Update
            removeAndRealign(
                    final Node removed,
     ...
     * </p>
     * <p>
     * Pro zachování smyslu grafu je nutné, aby se stará a nová verze nelišily v
     * pozici ({@link PositionalNode}), ale jen funkčně ({@link FunctionalNode}
     * )!
     * </p>
     * 
     * @param oldVersion
