...
public class EnterRandomProcessingNode extends AbstractNode implements RandomNode, ProcessingNode, EnterNode {
    ...
    public static EnterRandomProcessingNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected EnterRandomProcessingNode(final String name, final Network parent, final int x, final int y) {
