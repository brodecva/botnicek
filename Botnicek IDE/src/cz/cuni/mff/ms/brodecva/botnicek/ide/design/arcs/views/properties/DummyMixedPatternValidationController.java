...
final class DummyMixedPatternValidationController implements
     ...
     * @return atrapa
     */
    public static DummyMixedPatternValidationController create() {
        return new DummyMixedPatternValidationController();
    }

    private DummyMixedPatternValidationController() {
    }
