 ...
 * @version 1.0
 */
public class SystemPane implements ArcPropertiesDisplayView, NetworkDisplayView, SystemView {
     ...
     * 
     * @param parent rodičovský kontejner plochy
     * @param systemController řadič systému sítí
     * @param networkDisplayController řadič zobrazení grafů sítí
     * @param arcPropertiesDisplayController řadič zobrazení vlastností sítí
     * @return správce plochy
     */
    public static SystemPane create(final Container parent, final SystemController systemController, final NetworkDisplayController networkDisplayController, final ArcPropertiesDisplayController arcPropertiesDisplayController) {
        ...
        final SystemPane newInstance = new SystemPane(systemController, networkDisplayController, arcPropertiesDisplayController);
    ...
    private static SystemPane create(final Container parent) {
        return create(parent, DummySystemController.create(), DummyNetworkDisplayController.create(), DummyArcPropertiesDisplayController.create());
    }

    private SystemPane(final SystemController systemController, final NetworkDisplayController networkPropertiesController, final ArcPropertiesDisplayController arcPropertiesController) {
        Preconditions.checkNotNull(systemController);
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.arcs.views.properties.ArcPropertiesDisplayView#arcDisplayed(cz.cuni.mff.ms.brodecva.botnicek.ide.design.arcs.controllers.ArcController, cz.cuni.mff.ms.brodecva.botnicek.ide.design.arcs.controllers.AvailableReferencesController, cz.cuni.mff.ms.brodecva.botnicek.ide.check.words.controllers.NormalWordValidationController, cz.cuni.mff.ms.brodecva.botnicek.ide.check.code.controllers.CodeValidationController, cz.cuni.mff.ms.brodecva.botnicek.ide.check.simplepattern.controllers.SimplePatternValidationController, cz.cuni.mff.ms.brodecva.botnicek.ide.check.mixedpattern.controllers.MixedPatternValidationController, cz.cuni.mff.ms.brodecva.botnicek.ide.check.words.controllers.NormalWordValidationController)
     */
    @Override
    public void arcDisplayed(final ArcController arcController, final AvailableReferencesController availableReferencesController, final NormalWordValidationController nameValidationController, final CodeValidationController codeValidationController, final SimplePatternValidationController simplePatternValidationController, final MixedPatternValidationController mixedPatternValidationController, final NormalWordValidationController predicateNameValidationController) {
        ...
        final ArcInternalWindow arcInternalWindow = ArcInternalWindow.create(this.desktopPane, arcController, availableReferencesController, nameValidationController, codeValidationController, simplePatternValidationController, mixedPatternValidationController, predicateNameValidationController);
    ...
    public void displayNetwork(final NetworkController networkController,
            ArcsController arcsController, NodesController nodesController, final ArcPropertiesDisplayController arcPropertiesController) {
        ...
        final NetworkInternalWindow networkWindow = NetworkInternalWindow.create(this.desktopPane, networkController, nodesController, arcsController, arcPropertiesController);
        networkWindow.show();
    }
     ...
     */
    @Override
    public void systemSet(System system) {
    }
