...
public final class Set extends AbstractCompoundElement implements CaptureElement {
    ...
    public static Set create(final PredicateName name, final TemplateElement... content) {
        Preconditions.checkNotNull(content);
        
        return create(name, Arrays.asList(content));
    }
    
    public static Set create(final PredicateName name, final List<TemplateElement> content) {
        return new Set(name, content);
    }
    
    private Set(final PredicateName name, final List<TemplateElement> content) {
        super(content);
