 ...
 * @version 1.0
 */
public class ArcRemovedEvent implements Event<ArcRemovedListener> {
    
    private final String name;
    
    public static ArcRemovedEvent create(final String name) {
        return new ArcRemovedEvent(name);
    }
    
    private ArcRemovedEvent(final String name) {
