...
public class ExitInputNode extends AbstractNode implements InputNode, ExitNode {
    ...
    public static ExitInputNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected ExitInputNode(final String name, final Network parent, final int x, final int y) {
