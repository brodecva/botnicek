...
/**
 * Pohled na vlastnosti hrany. Je jednotný pro všechny typy, které dle potřeby předefinují relevantní aktualizační metody.
 * 
...
public interface ArcView {
     ...
     * 
     * @param name nový název výchozího uzlu hrany
     */
     ...
     * 
     * @param name nový název cílového uzlu hrany
     */
     ...
     * 
     * @param value nový vzor očekávané hodnoty
     */
     ...
     * 
     * @param name nový název testovaného predikátu
     */
