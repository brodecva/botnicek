...
public class DefaultMixedPatternValidator implements MixedPatternValidator {
     ...
     */
    public static DefaultMixedPatternValidator create(final MixedPatternChecker checker, final Dispatcher dispatcher) {
        return new DefaultMixedPatternValidator(checker, dispatcher);
    }
    
    private DefaultMixedPatternValidator(final MixedPatternChecker checker, final Dispatcher dispatcher) {
