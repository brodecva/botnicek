...
/**
 * Panel pro nastavení hrany, která testuje výstup kódu šablony oproti očekávané
 * hodnotě.
 * 
...
public class CodeTestArcPanel extends AbstractTypePanel {
    ...
    private static final Dimension VALUE_REQUESTED_DIMENSION = new Dimension(
            VALUE_TEXT_FIELD_WIDTH, VALUE_TEXT_FIELD_HEIGHT);

    private static final Dimension VALUE_CONSTRAINED_DIMENSION = new Dimension(
            Short.MAX_VALUE, VALUE_TEXT_FIELD_HEIGHT);

    private static final Dimension CODE_EDITOR_DIMENSION = new Dimension(
            CODE_EDITOR_WIDTH, CODE_EDITOR_HEIGHT);
    ...
    public static
        ...
        final CodeEditorPane testedCodeEditorPane =
                CodeEditorPane.create(parent, codeValidationController);

        final CodeTestArcPanel newInstance =
                new CodeTestArcPanel(arcController, valueTextField,
                        testedCodeEditorPane);
    ...
    private CodeTestArcPanel(final ArcController arcController,
            final SimplePatternTextField valueTextField,
            final CodeEditorPane testedCodeEditorPane) {
        Preconditions.checkNotNull(arcController);
        ...
        final ScrollableEditorPanel testedCodeScrollableEditorPanel =
                new ScrollableEditorPanel(this.testedCodeEditorPane);
        final JScrollPane testedCodeScrollPane =
                new JScrollPane(testedCodeScrollableEditorPanel);
        testedCodeScrollPane.setMinimumSize(CODE_EDITOR_DIMENSION);
        testedCodeScrollPane.setPreferredSize(CODE_EDITOR_DIMENSION);
        testedCodeScrollPane.setBorder(BorderFactory
                .createTitledBorder(UiLocalizer
                        .print("ExpressionGeneratingCode")));
    ...
    public void
        ...
        this.arcController.updateCodeTest(newName, priority, code,
                this.testedCodeEditorPane.getText(),
     ...
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.arcs.views.types.
     * AbstractTypePanel
     * #updatedTested(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.types.Code)
     */
    @Override
     ...
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.design.arcs.views.types.
     * AbstractTypePanel
     * #updatedValue(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.types
     * .SimplePattern)
     */
    @Override
