 ...
 * @version 1.0
 */
public final class InnerOrderedInputNode extends AbstractNode implements
        OrderedNode, InputNode, InnerNode {
     ...
     * @return uzel
     */
    public static InnerOrderedInputNode create(final NormalWord name,
    ...
    private InnerOrderedInputNode(final NormalWord name, final Network parent,
