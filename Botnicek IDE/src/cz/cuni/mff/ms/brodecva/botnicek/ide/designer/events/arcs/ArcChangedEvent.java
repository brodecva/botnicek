 ...
 */
package cz.cuni.mff.ms.brodecva.botnicek.ide.designer.events.arcs;
 ...
 * @version 1.0
 */
public class ArcChangedEvent implements Event<ArcChangedListener> {
    
    private final Arc newArc;
    
    public static ArcChangedEvent create(final Arc newArc) {
        return new ArcChangedEvent(newArc);
    }
    
    private ArcChangedEvent(final Arc newArc) {
