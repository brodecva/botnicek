 ...
 * @version 1.0
 */
public class ArcAddedEvent implements Event<ArcAddedListener> {
    
    private final Arc newArc;
    
    public static ArcAddedEvent create(final Arc newArc) {
        return new ArcAddedEvent(newArc);
    }
    
    private ArcAddedEvent(final Arc newArc) {
