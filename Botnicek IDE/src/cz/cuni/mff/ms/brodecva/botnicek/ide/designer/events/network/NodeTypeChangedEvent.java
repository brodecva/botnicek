 ...
 * @version 1.0
 */
public class NodeTypeChangedEvent implements Event<NodeTypeChangedListener> {
    
    private final String name;
    private final Class<? extends Node> newType;
    
    public static NodeTypeChangedEvent create(final String name, final Class<? extends Node> newType) {
        return new NodeTypeChangedEvent(name, newType);
    }
    
    private NodeTypeChangedEvent(final String name, final Class<? extends Node> newType) {
    ...
    public void dispatchTo(final NodeTypeChangedListener listener) {
        listener.nodeTypeChanged(this.name, this.newType);
    }
