...
/**
 * Výchozí implementace řadiče pro validaci normálního slova dle specifikace jazyka AIML.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class DefaultNormalWordValidationController implements NormalWordValidationController {
     ...
     * Vytvoří řadič.
     * 
     * @param namingAuthority autorita pro přidělování unikátních řetězců 
     * @param eventManager správce událostí
     * @return řadič
     */
    public static DefaultNormalWordValidationController create(final NamingAuthority namingAuthority, final EventManager eventManager) {
        return create(DefaultNormalWordValidator.create(DefaultNormalWordChecker.create(namingAuthority), eventManager), eventManager);
    }
     ...
     * @return řadič
     */
    public static DefaultNormalWordValidationController create(final NormalWordChecker checker, final EventManager eventManager) {
        return create(DefaultNormalWordValidator.create(checker, eventManager), eventManager);
    }
     ...
     * @return řadič
     */
    public static DefaultNormalWordValidationController create(final NormalWordValidator validator, final EventManager eventManager) {
     ...
     * Vytvoří řadič.
     * 
     * @param checkController implementující řadič (validuje normální slovo)
     * @return řadič
     */
    public static DefaultNormalWordValidationController create(final CheckController checkController) {
        return new DefaultNormalWordValidationController(checkController);
    }
    
    private DefaultNormalWordValidationController(final CheckController checkController) {
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.check.common.controllers.CheckController#check(cz.cuni.mff.ms.brodecva.botnicek.ide.check.common.model.Source, java.lang.Object, java.lang.String)
     */
    @Override
