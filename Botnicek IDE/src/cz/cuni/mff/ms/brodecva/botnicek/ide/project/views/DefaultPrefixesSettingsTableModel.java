 ...
 * </p>
 * <p>
 * Je vždy zajištěno, že tabulka obsahuje nějaký prefix pro prostor jmen AIML a
 * nějaký prefix pro jeho schéma.
 * </p>
 * <p>
 * Model nekontroluje unikátnost prefixů. V takové situaci je lepší užít prefixu
 * explicitně ve zdrojovém kódu. Též se nelze spolehnout na validitu samotných
 * řetězců prefixů podle pravidel XML.
 * </p>
 * 
 * @author Václav Brodec
 * @version 1.0
 */
final class DefaultPrefixesSettingsTableModel extends
        AbstractNameValueTableModel<URI, String> implements
        PrefixesSettingsTableModel {
    ...
    public static DefaultPrefixesSettingsTableModel create() {
        ...
        namespacesToPrefixes.put(URI.create(AIML.NAMESPACE_URI.getValue()),
                AIML.DEFAULT_PREFIX.getValue());
        namespacesToPrefixes.put(
     ...
     *            zobrazení URI prostorů jmen na prefixy
     * @return model
    ...
    public static DefaultPrefixesSettingsTableModel create(
        ...
        Preconditions.checkArgument(copy.containsKey(URI
    ...
    public boolean isCellEditable(final int rowIndex, final int columnIndex) {
        if (columnIndex == 0) {
            ...
            if (value.equals(AIML.NAMESPACE_URI.getValue())
                    || value.equals(XML.SCHEMA_NAMESPACE_URI.getValue())) {
                return false;
            }
        }
