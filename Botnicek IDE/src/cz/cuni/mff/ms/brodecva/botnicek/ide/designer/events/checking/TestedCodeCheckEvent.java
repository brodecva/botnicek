 ...
 * @version 1.0
 */
public class TestedCodeCheckEvent implements Event<TestedCodeCheckListener> {
    
    private final CodeTestArc arc;
    private final CodeCheckResult result;
    
    public static TestedCodeCheckEvent create(final CodeTestArc arc, final CodeCheckResult result) {
        return new TestedCodeCheckEvent(arc, result);
    }
    
    private TestedCodeCheckEvent(final CodeTestArc arc, final CodeCheckResult result) {
     ...
     */
    @Override
    public void dispatchTo(final TestedCodeCheckListener listener) {
