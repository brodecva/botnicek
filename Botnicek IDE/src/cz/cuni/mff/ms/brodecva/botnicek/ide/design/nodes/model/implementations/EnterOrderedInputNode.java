 ...
 * @version 1.0
 */
public final class EnterOrderedInputNode extends AbstractNode implements
        OrderedNode, InputNode, EnterNode {
     ...
     * @return uzel
     */
    public static EnterOrderedInputNode create(final NormalWord name,
    ...
    private EnterOrderedInputNode(final NormalWord name, final Network parent,
