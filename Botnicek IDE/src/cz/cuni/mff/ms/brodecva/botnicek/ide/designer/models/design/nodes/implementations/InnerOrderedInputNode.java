 ...
 * @version 1.0
 */
public class InnerOrderedInputNode extends AbstractNode implements OrderedNode, InputNode, InnerNode {

    public static InnerOrderedInputNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected InnerOrderedInputNode(final String name, final Network parent, final int x, final int y) {
        super(name, parent, x, y);
    }
    
    protected InnerOrderedInputNode(final Node original) {
        super(original);
    }
