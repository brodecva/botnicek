 ...
 * @version 1.0
 */
public class PatternCheckEvent implements Event<PatternCheckListener> {
    
    private final PatternArc arc;
    private final SimplePatternCheckResult result;
    
    public static PatternCheckEvent create(final PatternArc arc, final SimplePatternCheckResult result) {
        return new PatternCheckEvent(arc, result);
    }
    
    private PatternCheckEvent(final PatternArc arc, final SimplePatternCheckResult result) {
     ...
     */
    @Override
    public void dispatchTo(final PatternCheckListener listener) {
