 ...
 * @version 1.0
 */
public class DefaultSystemController extends AbstractController<SystemView>
        implements SystemController {

    private final class DefaultNetworkAddedListener implements
    ...
    private final class DefaultSystemClosedListener implements
            SystemClosedListener {

        @Override
        public void closed() {
            Preconditions.checkNotNull(DefaultSystemController.this.system);
    ...
    private final class DefaultSystemRenamedListener implements
            SystemRenamedListener {
     ...
     * @return řadič
     */
    public static DefaultSystemController create(final System system,
            final EventManager eventManager) {
        final DefaultSystemController newInstance =
                new DefaultSystemController(system, eventManager);

        newInstance.addListener(NetworkAddedEvent.class, system,
                newInstance.new DefaultNetworkAddedListener());
        newInstance.addListener(NetworkRemovedEvent.class, system,
                newInstance.new DefaultNetworkRemovedListener());
        newInstance.addListener(NetworkRenamedEvent.class, system,
                newInstance.new DefaultNetworkRenamedListener());
        newInstance.addListener(SystemClosedEvent.class, system,
                newInstance.new DefaultSystemClosedListener());
        newInstance.addListener(SystemRenamedEvent.class, system,
                newInstance.new DefaultSystemRenamedListener());
    ...
    private DefaultSystemController(final System system,
            final EventManager eventManager) {
        super(eventManager);
    ...
    public void removeNetwork(Network removed) {
        ...
        this.system.removeNetwork(removed);
    }
     ...
     * .networks.model.NetworkInfo, java.lang.String)
     */
    @Override
