 ...
 * @version 1.0
 */
public final class LanguageSettingsChangedEvent extends AbstractMappedEvent<Project, LanguageSettingsChangedListener> {
     ...
     * Vytvoří událost.
     * 
     * @param project související projekt
     * @param settings nastavení jazyka
     * @return událost
     */
    public static LanguageSettingsChangedEvent create(final Project project, final LanguageConfiguration settings) {
        return new LanguageSettingsChangedEvent(project, settings);
    }
    
    private LanguageSettingsChangedEvent(final Project project, final LanguageConfiguration settings) {
        super(project);
