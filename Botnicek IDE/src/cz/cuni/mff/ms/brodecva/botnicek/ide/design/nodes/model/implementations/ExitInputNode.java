 ...
 * @version 1.0
 */
public final class ExitInputNode extends AbstractNode implements InputNode,
        ExitNode {
     ...
     * @return uzel
     */
    public static ExitInputNode create(final NormalWord name,
    ...
    private ExitInputNode(final NormalWord name, final Network parent,
