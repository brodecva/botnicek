...
public class EnterOrderedInputNode extends AbstractNode implements OrderedNode, InputNode, EnterNode {
    ...
    public static EnterOrderedInputNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param x 
     */
    protected EnterOrderedInputNode(final String name, final Network parent, final int x, final int y) {
