...
/**
 * <p>
 * Správce tabulky s výsledky neúspěšných kontrol.
 * </p>
 * <p>
...
public final class ResultsTable implements CheckView {
    ...
    private static final List<Integer> COLUMNS_SIZES = ImmutableList.of(
            DEFAULT_COLUMN_WIDTH * 10, DEFAULT_COLUMN_WIDTH * 3,
    ...
    static ResultsTable create(final JScrollPane parent,
        ...
        final ResultsTable newInstance =
                new ResultsTable(checkControllersCopy, model);
    ...
    private ResultsTable(final Set<CheckController<?>> checkControllers,
        ...
        for (int columnIndex = 0; columnIndex < columnCount; columnIndex++) {
            final TableColumn column =
                    this.table.getColumnModel().getColumn(columnIndex);
     ...
     * 
     * @see
     * cz.cuni.mff.ms.brodecva.botnicek.ide.check.common.views.CheckResultView
     * #closed()
     */
    @Override
    public void closed() {
     ...
     * cz.cuni.mff.ms.brodecva.botnicek.ide.check.common.views.CheckResultView
     * #updateResult
     * (cz.cuni.mff.ms.brodecva.botnicek.ide.check.common.model.CheckResult)
     */
    @Override
