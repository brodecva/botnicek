 ...
 */
package cz.cuni.mff.ms.brodecva.botnicek.ide.translate.utils;
...
public final class Stack {
    ...
    public static TemplateElement push(final NormalWord word) {
        final String delimiter = AIML.WORD_DELIMITER.getValue();
        
        return push(Text.create(word.getText()), Text.create(delimiter));
    }
    ...
    public static TemplateElement set(final List<TemplateElement> content) {
        final Set update = Set.create(NormalWords.of(AIML.TOPIC.getValue()), ImmutableList.copyOf(content));
