...
/**
 * Model tabulky s přiřazením predikátu (jeho názvu) k zobrazovací strategie nastavení jeho hodnoty.
 * 
 * @author Václav Brodec
 * @version 1.0
 * @see DisplayStrategy
 */
public class DisplayStrategyTableModel extends AbstractNameValueTableModel<NormalWord, DisplayStrategy> {
     ...
     * 
     * @param namesToValues původní nastavení
     * @return model
     */
    public static DisplayStrategyTableModel create(final Map<NormalWord, DisplayStrategy> namesToValues) {
        return new DisplayStrategyTableModel(namesToValues, DefaultDisplayStrategyFactory.create());
    }
     ...
     * 
     * @param namesToValues původní nastavení
     * @param strategyFactory továrna na konverzi textových popisů na strategie
     * @return model
     */
    public static DisplayStrategyTableModel create(final Map<NormalWord, DisplayStrategy> namesToValues, final DisplayStrategyFactory strategyFactory) {
        return new DisplayStrategyTableModel(namesToValues, strategyFactory);
    }

    private DisplayStrategyTableModel(final DisplayStrategyFactory strategyFactory) {
        super(UiLocalizer.print("PREDICATE_COLUMN_NAME"), UiLocalizer.print("STRATEGY_COLUMN_NAME"));
    ...
    private DisplayStrategyTableModel(final Map<NormalWord, DisplayStrategy> namesToValues, final DisplayStrategyFactory strategyFactory) {
        super(namesToValues, UiLocalizer.print("PREDICATE_COLUMN_NAME"), UiLocalizer.print("STRATEGY_COLUMN_NAME"));
    ...
    /* (non-Javadoc)
     * @see cz.cuni.mff.ms.brodecva.botnicek.ide.utils.swing.NameValueTableModel#valueToString(java.lang.Object)
     */
    @Override
