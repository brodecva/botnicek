 ...
 * @version 1.0
 */
public class NodeMovedEvent extends AbstractMappedEvent<Network, NodeMovedListener> {
     ...
     * @return událost
     */
    public static NodeMovedEvent create(final Network network, final Node oldVersion, final Node newVersion) {
        return new NodeMovedEvent(network, oldVersion, newVersion);
    }
    
    private NodeMovedEvent(final Network network, final Node oldVersion, final Node newVersion) {
        super(network);
