 ...
 * @version 1.0
 */
public final class ExitProcessingNode extends AbstractNode implements
        ProcessingNode, ExitNode {
     ...
     * @return uzel
     */
    public static ExitProcessingNode create(final NormalWord name,
    ...
    private ExitProcessingNode(final NormalWord name, final Network parent,
