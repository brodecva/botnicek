...
public interface CheckResult {
    ...
    /**
     * Porovná výsledek s objektem. Shoduje se pouze s dalším výsledkem, který
     * má stejný předmět.
     */
    @Override
    ...
    /**
     * Vrátí identifikátor souvisejících výsledků. Klienti validačního
     * mechanismu mohou přiřazovat požadavkům o validaci vlastní předmět, který
     * dovoluje aktualizovat výsledky týkající se stejného předmětu.
     * 
