...
/**
 * Knihovna s tématy pro vyhodnocení úspěchu zanoření do podsítě a průchodu
 * celým systémem.
 * 
...
public final class Recursion {
    /**
     * Vrátí témata zajišťující: úklid zásobníku po úspěšném průchodu v zanořené
     * sítí, návrat do původní a přechod na další stavy v zásobníku v případě
     * neúspěchu.
     * 
     * @param pullState
     *            stav pro úklid stavů, které jsme rozbalili, ale kvůli úspěchu
     *            je není třeba procházet (umisťuje se po opuštění sítě cílový
     *            stavem)
     * @param pullStopState
     *            zarážka úklidu (umisťuje se po vejití do sítě vstupním uzlem)
     * @param successState
     *            stav indikující úspěšně projití podsítě, v případě jinak
     *            prázdného zásobníku pak celého systému
     * @param failState
     *            stav indikující neúspěšné ukončení výpočtu
     * @param returnState
     *            stav uvozující návratový stav do sítě o úroveň výše při
     *            zanoření
     * @return knihovní témata
     */
    public static List<Topic> getLibrary(final NormalWord pullState,
