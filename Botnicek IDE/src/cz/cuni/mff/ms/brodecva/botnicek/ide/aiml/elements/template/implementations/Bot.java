...
/**
 * Vrátí hodnotu uloženou v přednastaveném predikátu bota. V případě, že není
 * predikát toho jména definován, vrací prázdný řetězec.
 * 
...
public final class Bot extends AbstractProperElement implements AtomicElement {
     ...
     * 
     * @param name
     *            název predikátu jen pro čtení, z kterého bude odečtena uložená
     *            hodnota
     * @return prvek
     */
    ...
    private Bot(final NormalWord name) {
