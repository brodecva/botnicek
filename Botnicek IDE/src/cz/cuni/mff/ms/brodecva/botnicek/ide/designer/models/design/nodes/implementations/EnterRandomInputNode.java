...
public class EnterRandomInputNode extends AbstractNode implements RandomNode, InputNode, EnterNode {
    ...
    public static EnterRandomInputNode create(final String name, final Network parent, final int x, final int y) {
     ...
     * @param name
     */
    protected EnterRandomInputNode(final String name, final Network parent, final int x, final int y) {
