...
@PrepareForTest({
        ...
        Topic.class,
        Patterns.class,
        cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category.class })
...
public class DefaultNodeTopicFactoryTest {
    ...
    public void setUp() throws Exception {
        ...
        PowerMock
                .mockStatic(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category.class);
    }
    ...
    public void testProduce() {
        ...
        final TemplateElement codeElementDummy =
                EasyMock.createStrictMock(TemplateElement.class);
        EasyMock.replay(codeElementDummy);

        final SimplePattern patternDummy =
                EasyMock.createStrictMock(SimplePattern.class);
        EasyMock.replay(patternDummy);

        EasyMock.expect(Patterns.create("NODENAME *")).andStubReturn(
                patternDummy);
        PowerMock.replay(Patterns.class);

        final Template templateDummy =
                PowerMock.createStrictMock(Template.class);
        PowerMock.replay(templateDummy);

        EasyMock.expect(Template.create(ImmutableList.of(codeElementDummy)))
                .andStubReturn(templateDummy);
        PowerMock.replay(Template.class);

        final cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category categoryDummy =
                EasyMock.createStrictMock(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category.class);
        PowerMock.replay(categoryDummy);

        EasyMock.expect(
                cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category
                        .createUniversal(templateDummy)).andStubReturn(
                categoryDummy);
        PowerMock
                .replay(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category.class);

        final Topic topicDummy = PowerMock.createStrictMock(Topic.class);
        PowerMock.replay(topicDummy);

        EasyMock.expect(Topic.create(patternDummy, categoryDummy))
                .andStubReturn(topicDummy);
        ...
        PowerMock
                .verify(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.elements.toplevel.Category.class);
    }
