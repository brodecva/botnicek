...
/**
 * Integrační test pomocných metod pro práci s virtuálním zásobníkem a výchozí implementace návštěvníka generujícího zdrojový kód AIML z objektového modelu dokumentu.
 * 
...
public class StackTest {
    ...
    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#pop()}.
     */
    @Test
    public void testPop() {
        Stack.pop().accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\"><topicstar/></set></think>", this.renderer.getResult());
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#popAndPushWords(cz.cuni.mff.ms.brodecva.botnicek.ide.aiml.types.NormalWord[])}.
     */
    @Test
    public void testPushWordsWhenEmpty() {
        Stack.popAndPushWords(ImmutableList.<NormalWord>of()).accept(this.renderer);
    ...
    public void testPushWordsWhenNotEmpty() {
        Stack.popAndPushWords(ImmutableList.of(NormalWords.of("FIRST"), NormalWords.of("SECOND"))).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">FIRST SECOND <topicstar/></set></think>", this.renderer.getResult());
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#joinWithSpaces(java.util.List)}.
     */
    @Test
    ...
    public void testJoinWithSpacesWhenNotEmpty() {
        assertEquals("FIRST SECOND", Stack.joinWithSpaces(ImmutableList.of(NormalWords.of("FIRST"), NormalWords.of("SECOND"))));
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#popAndPush(java.util.List)}.
     */
    @Test
    public void testPushListOfTemplateElementWhenEmpty() {
        Stack.popAndPush(ImmutableList.<TemplateElement>of()).accept(this.renderer);
    ...
    public void testPushListOfTemplateElementWhenNotEmpty() {
        Stack.popAndPush(ImmutableList.<TemplateElement>of(Text.create("FIRST"), Text.create(AIML.WORD_DELIMITER.getValue()), Get.create(NormalWords.of("SECOND")))).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">FIRST <get name=\"SECOND\"/> <topicstar/></set></think>", this.renderer.getResult());
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#prepend(java.util.List, java.util.List)}.
     */
    @Test
    public void testPrependWhenWordsEmptyRestNotEmpty() {
        Stack.prepend(ImmutableList.<NormalWord>of(), ImmutableList.<TemplateElement>of(Text.create("FIRST"), Text.create(AIML.WORD_DELIMITER.getValue()), Get.create(NormalWords.of("SECOND")))).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">FIRST <get name=\"SECOND\"/></set></think>", this.renderer.getResult());
    }
    ...
    public void testPrependWhenWordsNotEmptyRestNotEmpty() {
        Stack.prepend(ImmutableList.of(NormalWords.of("FIRST"), NormalWords.of("SECOND")), ImmutableList.<TemplateElement>of(Text.create("THIRD"), Text.create(AIML.WORD_DELIMITER.getValue()), Get.create(NormalWords.of("FOURTH")))).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">FIRST SECOND THIRD <get name=\"FOURTH\"/></set></think>", this.renderer.getResult());
    }
    ...
    public void testPrependWhenWordsEmptyRestEmpty() {
        Stack.prepend(ImmutableList.<NormalWord>of(), ImmutableList.<TemplateElement>of()).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\"/></think>", this.renderer.getResult());
    }
    ...
    public void testPrependWhenWordsNotEmptyRestEmpty() {
        Stack.prepend(ImmutableList.of(NormalWords.of("FIRST"), NormalWords.of("SECOND")), ImmutableList.<TemplateElement>of()).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">FIRST SECOND</set></think>", this.renderer.getResult());
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#concatenate(java.util.List, java.util.List)}.
     */
    @Test
    public void testConcatenateWhenFirstEmptySecondEmpty() {
        Stack.concatenate(ImmutableList.<TemplateElement>of(), ImmutableList.<TemplateElement>of()).accept(this.renderer);
    ...
    public void testConcatenateWhenFirstNotEmptySecondEmpty() {
        Stack.concatenate(ImmutableList.<TemplateElement>of(
                ...
                Random.create(ImmutableList.<List<TemplateElement>>of(ImmutableList.<TemplateElement>of(Text.create("ONE")),
                        ImmutableList.<TemplateElement>of(Text.create("TWO"))))),
                ImmutableList.<TemplateElement>of()).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\"><date/> <random><li>ONE</li><li>TWO</li></random></set></think>", this.renderer.getResult());
    }
    ...
    public void testConcatenateWhenFirstEmptySecondNotEmpty() {
        Stack.concatenate(ImmutableList.<TemplateElement>of(),
                ImmutableList.<TemplateElement>of(
                        Text.create("THIRD"),
                        Text.create(AIML.WORD_DELIMITER.getValue()),
                        Get.create(NormalWords.of("FOURTH")))).accept(this.renderer);
        
        assertEquals("<think><set name=\"TOPIC\">THIRD <get name=\"FOURTH\"/></set></think>", this.renderer.getResult());
    }
    ...
    public void testConcatenateWhenFirstNotEmptySecondNotEmpty() {
        ...
        assertEquals("<think><set name=\"TOPIC\"><date/> <random><li>ONE</li><li>TWO</li></random> THIRD <get name=\"FOURTH\"/></set></think>", this.renderer.getResult());
    }

    /**
     * Test method for {@link cz.cuni.mff.ms.brodecva.botnicek.ide.translate.Stack#set(java.util.List)}.
     */
    @Test
    ...
    public void testSetListOfTemplateElementWhenNotEmpty() {
        Stack.set(ImmutableList.<TemplateElement>of(
                Date.create(),
                Text.create(AIML.WORD_DELIMITER.getValue()),
                Random.create(ImmutableList.<List<TemplateElement>>of(ImmutableList.<TemplateElement>of(Text.create("ONE")),
                        ImmutableList.<TemplateElement>of(Text.create("TWO")))),
