...
/**
 * Testuje procesor pro odečítání hodnoty predikátu bota.
 * 
...
public final class BotProcessorTest {
    ...
    public void setUp() {
        ...
        expect(botMock.getPredicateValue(eq(DEFINED_KEY))).andStubReturn(
                DEFINED_VALUE);
        expect(botMock.getPredicateValue(eq(UNDEFINED_KEY))).andStubReturn(
                EMPTY_STRING);
        replay(botMock);
    ...
    /**
     * Test pro
     * {@link cz.cuni.mff.ms.brodecva.botnicek.library.processor.BotProcessor#process(org.w3c.dom.Element, cz.cuni.mff.ms.brodecva.botnicek.library.parser.TemplateParser)}
     * .
     * 
