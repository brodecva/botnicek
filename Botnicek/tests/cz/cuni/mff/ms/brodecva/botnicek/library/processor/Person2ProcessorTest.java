...
/**
 * Testuje procesor pro záměnu 1. a 3. osoby.
 * 
 * @author Václav Brodec
 * @version 1.0
 * @see Person2Processor
 */
public final class Person2ProcessorTest {
    ...
    public void setUp() throws ProcessorException {
        processor = new Person2Processor();
        ...
        expect(languageMock.transformPerson2(isA(String.class))).andReturn(
    ...
    /**
     * Test pro
     * {@link cz.cuni.mff.ms.brodecva.botnicek.library.processor.Person2Processor#process(org.w3c.dom.Element, cz.cuni.mff.ms.brodecva.botnicek.library.parser.TemplateParser)}
     * .
     * 
     * @throws ProcessorException
     *             chyba při zpracování
