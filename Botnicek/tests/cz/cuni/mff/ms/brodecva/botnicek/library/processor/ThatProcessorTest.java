...
/**
 * Testuje procesor získávání minulého botova výstupu.
 * 
...
public final class ThatProcessorTest {

    /**
     * Očekávaný minulý výstup.
     */
    ...
    public void setUp() throws ProcessorException, IOException {
        ...
        expect(conversationMock.getBotOutput(isA(TwoDimensionalIndex.class)))
        ...
        processor = new ThatProcessor(factoryMock);
    }
    ...
    /**
     * Test pro
     * {@link cz.cuni.mff.ms.brodecva.botnicek.library.processor.ThatProcessor#process(org.w3c.dom.Element, cz.cuni.mff.ms.brodecva.botnicek.library.parser.TemplateParser)}
     * .
     * 
     * @throws ProcessorException
     *             chyba při zpracování
     */
    @Test
    public void testProcessReturnsOutput() throws ProcessorException {
