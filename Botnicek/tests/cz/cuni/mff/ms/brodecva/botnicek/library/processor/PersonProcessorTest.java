...
/**
 * Testuje procesor pro záměnu 1. a 2. osoby.
 * 
...
public final class PersonProcessorTest {
    ...
    public void setUp() throws ProcessorException {
        ...
        expect(languageMock.transformPerson(isA(String.class))).andReturn(
    ...
    /**
     * Test pro
     * {@link cz.cuni.mff.ms.brodecva.botnicek.library.processor.PersonProcessor#process(org.w3c.dom.Element, cz.cuni.mff.ms.brodecva.botnicek.library.parser.TemplateParser)}
     * .
     * 
     * @throws ProcessorException
     *             chyba při zpracování
