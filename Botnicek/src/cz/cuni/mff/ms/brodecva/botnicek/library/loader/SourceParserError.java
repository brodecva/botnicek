...
/**
 * Závažná chyba při načítání.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public class SourceParserError extends Error {

    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -4562893164410251776L;

    /**
     * Vytvoří novou chybu s {@code null} místo podrobné zprávy. Příčina
     * není inicializována, může být dodatečně nastavena voláním
     * {@link Throwable#initCause(java.lang.Throwable)}.
     */
    public SourceParserError() {
        super();
    }
     ...
     */
    public SourceParserError(final String message) {
        super(message);
    }

    /**
     * Vytvoří novou chybu s danou příčinou a podrobnou zprávou
     * {@code (cause==null \? null : cause.toString()} (což typicky
     * obsahuje třídu a podrobnou zprávu o příčině). Tento konstruktor je
     * užitečný pro chyby, které nejsou nic víc než obaly pro jiné vyhoditelné
     * objekty.
     * 
     * @param cause
     ...
     */
    public SourceParserError(final Throwable cause) {
        super(cause);
    }
     ...
     *            povolena: říká, že příčina neexistuje či není známa.)
     */
    public SourceParserError(final String message, final Throwable cause) {
        super(message, cause);
    }
