...
/**
 * Prohodí zmínky o pohlaví v textu.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class GenderProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = 3489417067050324663L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        if (children.getLength() == 0) {
            return parser.processShortenedTag(element, AIML.GENDER.getValue(),
                    AIML.STAR.getValue());
        }

        return parser.getBot().getLanguage()
                .swapGender(parser.evaluate(children));
    }
