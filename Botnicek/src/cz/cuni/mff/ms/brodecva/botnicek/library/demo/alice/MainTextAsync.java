...
import cz.cuni.mff.ms.brodecva.botnicek.library.demo.AsyncInputActionListener;
import cz.cuni.mff.ms.brodecva.botnicek.library.demo.Gui;
import cz.cuni.mff.ms.brodecva.botnicek.library.demo.GuiText;
 ...
 * @version 1.0
 */
public final class MainTextAsync {
    
    /**
     * Logger.
     */
    private static final Logger LOGGER = BotnicekLogger
            .getLogger(MainTextAsync.class);
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final Gui gui = new GuiText(session.getBot().getName());
                    
                    final ActionListener listener = new AsyncInputActionListener(session, gui);
