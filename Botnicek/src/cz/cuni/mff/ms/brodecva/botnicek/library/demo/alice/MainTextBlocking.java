...
/**
 * GUI demonstrační aplikace s blokováním při čekání na vstupy a zobrazením čistého textu.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class MainTextBlocking {
    
    /**
     * Logger.
     */
    private static final Logger LOGGER = BotnicekLogger
            .getLogger(MainTextBlocking.class);
