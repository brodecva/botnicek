...
/**
 * Vrátí předchozí uživatelský vstup určený dvojrozměrným indexem (n-tá poslední
 * promluva, věta).
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class InputProcessor extends StarReferenceProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -3250840119942158055L;
    ...
    /**
     * Vytvoří procesor s danou továrnou na indexy.
     * 
     * @param indexFactory
     *            továrna na indexy
     */
    public InputProcessor(final IndexFactory indexFactory) {
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        final TwoDimensionalIndex index = indexFactory.create2DIndex(element);

        return parser.getConversation().getUserInput(index);
    }
