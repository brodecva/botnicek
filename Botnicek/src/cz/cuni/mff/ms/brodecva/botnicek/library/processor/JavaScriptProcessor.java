...
/**
 * Zpracuje prvek javascript. Obsah ignoruje (dle specifikace není provedení
 * vstupu povinné).
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class JavaScriptProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = 4067093196511686298L;
