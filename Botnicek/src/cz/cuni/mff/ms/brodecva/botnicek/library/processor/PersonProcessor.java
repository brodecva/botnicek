 ...
 * @version 1.0
 */
public final class PersonProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = 2016978902198791112L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        if (children.getLength() == 0) {
            return parser.processShortenedTag(element, AIML.PERSON.getValue(),
                    AIML.STAR.getValue());
        }

        return parser.getBot().getLanguage()
                .transformPerson(parser.evaluate(children));
    }
