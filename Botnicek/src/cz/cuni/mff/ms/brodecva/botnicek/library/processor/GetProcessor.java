...
/**
 * Načte a vrátí hodnotu predikátu.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class GetProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = 5281021664257785032L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        final String name = element.getAttribute(AIML.ATT_NAME.getValue()); 
        
        return conversation.getPredicateValue(
                name);
    }
