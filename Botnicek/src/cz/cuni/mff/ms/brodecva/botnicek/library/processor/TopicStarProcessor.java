...
/**
 * Zpracuje reference na žolík typu hvězdička v části označující téma.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class TopicStarProcessor extends StarReferenceProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -8348085077908826340L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        return process(element, parser, parser.getMatchResult()
                .getStarMatchedParts(AIMLPartMarker.TOPIC));
    }
