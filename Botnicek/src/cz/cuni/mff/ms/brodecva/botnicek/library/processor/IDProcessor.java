...
/**
 * Vrátí uživatelovo ID. Výchozí je localhost.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class IDProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -6572819983408000171L;

    /**
     * Výchozí ID.
     */
    public static final String DEFAULT_ID = "localhost";
