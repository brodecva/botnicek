...
/**
 * Zpracuje reference na žolík typu hvězdička v odkazu na předchozí reakci.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class ThatStarProcessor extends StarReferenceProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -4916874376795633827L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        return process(element, parser, parser.getMatchResult()
                .getStarMatchedParts(AIMLPartMarker.THAT));
    }
