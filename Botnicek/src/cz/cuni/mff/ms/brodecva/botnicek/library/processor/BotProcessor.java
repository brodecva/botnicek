...
/**
 * Vrací predikát definovaný pro bota.
 * 
 * @author Václav Brodec
 * @version 1.0
 */
public final class BotProcessor extends AbstractProcessor {
    /**
     * UID serializované verze.
     */
    private static final long serialVersionUID = -1068180656278772925L;
    ...
    public String process(final Element element, final TemplateParser parser)
        ...
        return bot.getPredicateValue(name); 
    }
